...
TEST(BookPrice, UpdateRandomLevels) {
  trdk::PriceBook book;
  {
    SCOPED_TRACE("Full");
...
TEST(BookPrice, AddRandomLevels) {
  trdk::PriceBook book;
  {
    SCOPED_TRACE("Full");
...
TEST(BookPrice, UpdatePredefinedLevels) {
  trdk::PriceBook book;
...
TEST(BookPrice, AddPredefinedLevels) {
  trdk::PriceBook book;
  trdk::PriceBook::Bid &bid = book.GetBid();
  trdk::PriceBook::Ask &ask = book.GetAsk();
