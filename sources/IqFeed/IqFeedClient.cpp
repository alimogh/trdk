...
IqFeedClient::Error::Error(const char *what) throw()
		: Exception(what) {
	//...//
}

IqFeedClient::ConnectError::ConnectError()
		: Error(IQFEED_CLIENT_CONNECTION_NAME " connection couldn't connect to IQLink") {
	//...//
}
