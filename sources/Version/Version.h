...
#define TRDK_GET_REQUIRED_MODUE_FILE_NAME_LIST() {"Core", "Engine", "TestTradingSystems", "InteractiveBrokers", "Services", "TestStrategy", "MrigeshKejriwal", };
