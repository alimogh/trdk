...
#define TRDK_GET_REQUIRED_MODUE_FILE_NAME_LIST() {"Core", "Engine", "FrontEnd", "Shell", "TestTradingSystems", "InteractiveBrokers", "FixProtocol", "Rest", "Services", "TestStrategy", "ArbitrationAdvisor", };
