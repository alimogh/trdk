...
#define TRDK_GET_REQUIRED_MODUE_FILE_NAME_LIST() {"Core", "Engine", "TestTradingSystems", "InteractiveBrokers", "FixProtocol", "Services", "TestStrategy", "MrigeshKejriwal", "DocFeels", };
