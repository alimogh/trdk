...
#define TRDK_VERSION_STATUS	6

#define TRDK_VERSION_BRANCH		"DocFeels"
#define TRDK_VERSION_BRANCH_W	L"DocFeels"
...
#define TRDK_GET_REQUIRED_MODUE_FILE_NAME_LIST() {"Core", "Engine", "TestTradingSystems", "Services", "TestStrategy", "DocFeels", };
