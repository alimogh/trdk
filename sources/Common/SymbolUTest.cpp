...
TEST(Symbol, GeneralErrors) {
  ...
  try {
    lib::Symbol("XXX/USD:NYMEX:FUX", lib::SECURITY_TYPE_FOR, lib::CURRENCY_AUD);
    EXPECT_TRUE(false) << "Exception expected.";
  } catch (const lib::Symbol::StringFormatError &ex) {
  ...
  try {
    lib::Symbol("XXX/USD:NYMEX:", lib::SECURITY_TYPE_FOR, lib::CURRENCY_AUD);
    EXPECT_TRUE(false) << "Exception expected.";
  } catch (const lib::Symbol::StringFormatError &ex) {
...
TEST(Symbol, FuturesOk) {
  ...
  {
    const lib::Symbol symbol("XXX/USD:NYMEX:FUT", lib::SECURITY_TYPE_STOCK);
    EXPECT_EQ(lib::SECURITY_TYPE_FUTURES, symbol.GetSecurityType());
    EXPECT_EQ(std::string("XXX"), symbol.GetSymbol());
    EXPECT_TRUE(symbol.IsExplicit());
    EXPECT_EQ(lib::CURRENCY_USD, symbol.GetCurrency());
  ...
  {
    const lib::Symbol symbol("XXX/USD:NYMEX", lib::SECURITY_TYPE_FUTURES,
                             lib::CURRENCY_AUD);
    EXPECT_EQ(lib::SECURITY_TYPE_FUTURES, symbol.GetSecurityType());
    EXPECT_EQ(std::string("XXX"), symbol.GetSymbol());
    EXPECT_TRUE(symbol.IsExplicit());
  ...
  {
    const lib::Symbol symbol("XXX:NYMEX", lib::SECURITY_TYPE_FUTURES,
                             lib::CURRENCY_AUD);
    EXPECT_EQ(lib::SECURITY_TYPE_FUTURES, symbol.GetSecurityType());
    EXPECT_EQ(std::string("XXX"), symbol.GetSymbol());
    EXPECT_TRUE(symbol.IsExplicit());
  ...
  {
    const lib::Symbol symbol("XXX", lib::SECURITY_TYPE_FUTURES,
                             lib::CURRENCY_AUD);
    EXPECT_EQ(lib::SECURITY_TYPE_FUTURES, symbol.GetSecurityType());
    EXPECT_EQ(std::string("XXX"), symbol.GetSymbol());
    EXPECT_TRUE(symbol.IsExplicit());
