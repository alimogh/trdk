...
#define TRDK_STRATEGY_WILLIAMCARRY_FILE_NAME "WilliamCarryStrategies"
#define TRDK_STRATEGY_WILLIAMCARRY_DLL_FILE_NAME \
  TRDK_STRATEGY_WILLIAMCARRY_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"
...
#define TRDK_STRATEGY_ARBITRATIONADVISER_FILE_NAME "ArbitrationAdviser"
#define TRDK_STRATEGY_ARBITRATIONADVISER_DLL_FILE_NAME \
  TRDK_STRATEGY_ARBITRATIONADVISER_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"
...
#define TRDK_GET_MODUE_FILE_NAME_LIST()                                        \
  {                                                                            \
    TRDK_CORE_FILE_NAME, TRDK_SERVICES_FILE_NAME, TRDK_PYAPI_FILE_NAME,        \
        ...
        TRDK_STRATEGY_ARBITRATIONADVISER_FILE_NAME,                            \
