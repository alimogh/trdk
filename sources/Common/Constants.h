...
#define TRDK_INTERACTION_LOGREPLY_FILE_NAME "LogReply"
#define TRDK_INTERACTION_LOGREPLY_DLL_FILE_NAME \
	TRDK_INTERACTION_LOGREPLY_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"
