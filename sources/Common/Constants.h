...
#define TRDK_INTERACTION_BINANCE_FILE_NAME "Binance"
#define TRDK_INTERACTION_BINANCE_DLL_FILE_NAME \
  TRDK_INTERACTION_BINANCE_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"

#define TRDK_INTERACTION_COINBASE_FILE_NAME "Coinbase"
#define TRDK_INTERACTION_COINBASE_DLL_FILE_NAME \
  TRDK_INTERACTION_COINBASE_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"

#define TRDK_INTERACTION_POLONIEX_FILE_NAME "Poloniex"
#define TRDK_INTERACTION_POLONIEX_DLL_FILE_NAME \
  TRDK_INTERACTION_POLONIEX_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"

#define TRDK_INTERACTION_BITTREX_FILE_NAME "Bittrex"
#define TRDK_INTERACTION_BITTREX_DLL_FILE_NAME \
  TRDK_INTERACTION_BITTREX_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"
...
#define TRDK_GET_MODULE_FILE_NAME_LIST()                                       \
  {                                                                            \
    TRDK_CORE_FILE_NAME, TRDK_ENGINE_FILE_NAME, TRDK_ENGINE_SERVER_FILE_NAME,  \
        ...
        TRDK_INTERACTION_BINANCE_FILE_NAME,                                    \
        TRDK_INTERACTION_COINBASE_FILE_NAME,                                   \
        TRDK_INTERACTION_POLONIEX_FILE_NAME,                                   \
        TRDK_INTERACTION_BITTREX_FILE_NAME, TRDK_STRATEGY_TEST_FILE_NAME,      \
