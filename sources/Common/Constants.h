...
#define TRDK_INTERACTION_RESTJSON_FILE_NAME "RestJson"
#define TRDK_INTERACTION_RESTJSON_DLL_FILE_NAME \
  TRDK_INTERACTION_RESTJSON_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"
...
#define TRDK_GET_MODUE_FILE_NAME_LIST()                                        \
  {                                                                            \
    TRDK_CORE_FILE_NAME, TRDK_SERVICES_FILE_NAME, TRDK_PYAPI_FILE_NAME,        \
        ...
        TRDK_INTERACTION_RESTJSON_FILE_NAME, TRDK_STRATEGY_TEST_FILE_NAME,     \
