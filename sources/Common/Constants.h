...
#define TRDK_INTERACTION_ONIXFIXENGINE_FILE_NAME "OnixFixEngine"
#define TRDK_INTERACTION_ONIXFIXENGINE_DLL_FILE_NAME \
	TRDK_INTERACTION_ONIXFIXENGINE_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"
