...
#define TRDK_STRATEGY_PINGPONG_FILE_NAME "PingPong"
#define TRDK_STRATEGY_PINGPONG_DLL_FILE_NAME \
  TRDK_STRATEGY_PINGPONG_FILE_NAME TRDK_FILE_MODIFICATOR ".DLL"

#define TRDK_STRATEGY_TRIANGULARARBITRAGE_FILE_NAME "TriangularArbitrage"
#define TRDK_STRATEGY_TRIANGULARARBITRAGE_DLL_FILE_NAME \
  TRDK_STRATEGY_TRIANGULARARBITRAGE_FILE_NAME TRDK_FILE_MODIFICATOR ".DLL"
...
#define TRDK_INTERACTION_EXMO_FILE_NAME "Exmo"
#define TRDK_INTERACTION_EXMO_DLL_FILE_NAME \
  TRDK_INTERACTION_EXMO_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"

#define TRDK_INTERACTION_HUOBI_FILE_NAME "Huobi"
...
#define TRDK_FRONTEND_CHARTS_FILE_NAME "Charts"
#define TRDK_FRONTEND_CHARTS_DLL_FILE_NAME \
  TRDK_FRONTEND_CHARTS_FILE_NAME TRDK_FILE_MODIFICATOR ".dll"

#define TRDK_FRONTEND_TERMINAL_FILE_NAME "Trdk"
