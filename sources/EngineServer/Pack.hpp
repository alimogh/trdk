...
msgpack::packer<Stream> &Pack(msgpack::packer<Stream> &o,
...
struct pack<trdk::PriceBook::Bid> {
  ...
  msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                                      const trdk::PriceBook::Bid &v) const {
...
struct pack<trdk::PriceBook::Ask> {
  template <typename Stream>
  msgpack::packer<Stream> &operator()(msgpack::packer<Stream> &o,
                                      const trdk::PriceBook::Ask &v) const {
    return trdk::EngineServer::Details::Pack(o, v);
  }
};
...
struct pack<trdk::EngineServer::DropCopyRecord> {
  ...
  packer<Stream> &operator()(
    ...
    foreach (const auto &i, record) {
      ...
      typedef DropCopyRecordFieldMsgpackVisitor<decltype(stream)> Visitor;
