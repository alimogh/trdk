...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libEngineService_dbg.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libEngineService_dbg.a: ${OBJECTFILES}
...
${OBJECTDIR}/trdk.EngineService.pb.o: trdk.EngineService.pb.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -DBOOST_ENABLE_ASSERT_HANDLER -DDEV_VER -D_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trdk.EngineService.pb.o trdk.EngineService.pb.cc

${OBJECTDIR}/trdk.EngineService.MarketData.pb.o: trdk.EngineService.MarketData.pb.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -DBOOST_ENABLE_ASSERT_HANDLER -DDEV_VER -D_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trdk.EngineService.MarketData.pb.o trdk.EngineService.MarketData.pb.cc

${OBJECTDIR}/trdk.EngineService.MarketDataSource.pb.o: trdk.EngineService.MarketDataSource.pb.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -DBOOST_ENABLE_ASSERT_HANDLER -DDEV_VER -D_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trdk.EngineService.MarketDataSource.pb.o trdk.EngineService.MarketDataSource.pb.cc

${OBJECTDIR}/trdk.EngineService.Control.pb.o: trdk.EngineService.Control.pb.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -DBOOST_ENABLE_ASSERT_HANDLER -DDEV_VER -D_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trdk.EngineService.Control.pb.o trdk.EngineService.Control.pb.cc

${OBJECTDIR}/trdk.EngineService.DropCopy.pb.o: trdk.EngineService.DropCopy.pb.cc 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -DBOOST_ENABLE_ASSERT_HANDLER -DDEV_VER -D_DEBUG -I.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/trdk.EngineService.DropCopy.pb.o trdk.EngineService.DropCopy.pb.cc
