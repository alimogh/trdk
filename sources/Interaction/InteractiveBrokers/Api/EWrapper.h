...
class EWrapper {
 public:
  ...
  virtual void contractDetails(int reqId,
                               const ContractDetails& contractDetails) = 0;
  ...
  virtual void position(const IBString& account,
                        const Contract& contract,
                        int position,
                        double avgCost) = 0;
