...
LDLIBSOPTIONS=-L/usr/local/boost/boost_1_51/lib ../../Common/dist/Release/GNU_4.7.1-Linux-x86/libcommon.a -Wl,-rpath,../../Core/dist/Release/GNU_4.7.1-Linux-x86 -L../../Core/dist/Release/GNU_4.7.1-Linux-x86 -lCore -lenyxmd -lboost_signals

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libEnyx.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libEnyx.${CND_DLIB_EXT}: ../../Common/dist/Release/GNU_4.7.1-Linux-x86/libcommon.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libEnyx.${CND_DLIB_EXT}: ../../Core/dist/Release/GNU_4.7.1-Linux-x86/libCore.so
...
${OBJECTDIR}/FirstLimitUpdateHandler.o: FirstLimitUpdateHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -Werror -DBOOST_DISABLE_ASSERTS -DNDEBUG -DNTEST -DTRADER_INTERACTION_ENYX -I../.. -I/usr/include/libenyxmd -I/usr/local/boost/boost_1_51/include -std=c++11 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/FirstLimitUpdateHandler.o FirstLimitUpdateHandler.cpp
