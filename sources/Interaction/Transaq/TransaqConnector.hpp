...
class TRDK_INTERACTION_TRANSAQ_API Connector : private boost::noncopyable {
 public:
  ...
  class ConnectException : public Exception {
   public:
    explicit ConnectException(const char *what) noexcept : Exception(what) {}
  };
 ...
 public:
  ...
  ModuleEventsLog &GetLog() { return m_log; }
 ...
 protected:
  ...
  std::pair<boost::property_tree::ptree, std::string> SendCommand(
      const char *command,
 ...
 private:
  ...
  void OnNewDataMessage(const boost::property_tree::ptree &,
                        const Lib::TimeMeasurement::Milestones &,
                        const Lib::TimeMeasurement::Milestones::TimePoint &);
  void OnErrorMessage(const boost::property_tree::ptree &,
                      const Lib::TimeMeasurement::Milestones &,
                      const Lib::TimeMeasurement::Milestones::TimePoint &);
  void OnMarketsInfoMessage(
      ...
      const Lib::TimeMeasurement::Milestones &,
      const Lib::TimeMeasurement::Milestones::TimePoint &);
  void OnBoardsInfoMessage(const boost::property_tree::ptree &,
                           const Lib::TimeMeasurement::Milestones &,
                           const Lib::TimeMeasurement::Milestones::TimePoint &);
...
class TRDK_INTERACTION_TRANSAQ_API TradingConnector : public Connector {
 ...
 public:
  explicit TradingConnector(const Context &,
                            ModuleEventsLog &,
                            const Lib::IniSectionRef &);
  virtual ~TradingConnector();

 public:
  OrderId SendSellOrder(const std::string &board,
                        const std::string &symbol,
                        double price,
                        uint8_t pricePrecision,
                        const Qty &,
                        const Lib::TimeMeasurement::Milestones &);
  OrderId SendBuyOrder(const std::string &board,
                       const std::string &symbol,
                       double price,
                       uint8_t pricePrecision,
                       const Qty &,
   ...
   *          is not found.
   */
  bool SendCancelOrder(const OrderId &,
                       const Lib::TimeMeasurement::Milestones &);
 ...
 protected:
  ...
  virtual void OnOrderUpdate(
      ...
      const Lib::TimeMeasurement::Milestones::TimePoint &) = 0;
  virtual void OnTrade(std::string &&id,
                       TradingSystemOrderId &&,
                       double price,
                       Qty &&) = 0;

 private:
  OrderId SendOrder(const boost::property_tree::ptree &,
  ...
  void OnOrdersMessage(const boost::property_tree::ptree &,
                       const Lib::TimeMeasurement::Milestones &,
                       const Lib::TimeMeasurement::Milestones::TimePoint &);
  void OnTradeMessage(const boost::property_tree::ptree &,
                      const Lib::TimeMeasurement::Milestones &,
                      const Lib::TimeMeasurement::Milestones::TimePoint &);
...
class MarketDataSourceConnector : public Connector {
 ...
 protected:
  ...
  virtual void OnLevel1Update(const std::string &board,
                              const std::string &symbol,
 ...
 private:
  void OnTicksMessage(const boost::property_tree::ptree &,
                      const Lib::TimeMeasurement::Milestones &,
                      const Lib::TimeMeasurement::Milestones::TimePoint &);
  void OnQuotationsMessage(const boost::property_tree::ptree &,
                           const Lib::TimeMeasurement::Milestones &,
                           const Lib::TimeMeasurement::Milestones::TimePoint &);
};
