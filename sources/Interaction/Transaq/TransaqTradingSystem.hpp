...
class TRDK_INTERACTION_TRANSAQ_API TradingSystem : public trdk::TradingSystem,
  ...
  typedef boost::multi_index_container<
      ...
      boost::multi_index::indexed_by<
          boost::multi_index::hashed_unique<
              ...
              boost::multi_index::member<Order, OrderId, &Order::id>>,
          boost::multi_index::hashed_unique<
              boost::multi_index::tag<ByTradingSystemOrderId>,
              boost::multi_index::member<Order,
 ...
 protected:
  ...
  virtual void OnOrderUpdate(
      ...
      const Lib::TimeMeasurement::Milestones::TimePoint &) override;
 ...
 private:
  void RegisterOrder(const Security &,
                     const OrderId &,
                     const Qty &,
